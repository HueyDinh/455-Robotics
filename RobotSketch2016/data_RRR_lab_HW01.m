...
% dh.t              = [nan,    30,    45,    15,     0]*pi/180;                   %joint angles  (first element ignored)
% dh.t              = [nan,   105,    45,   -60,     0]*pi/180;                   %joint angles  (first element ignored)
dh.t              = [nan,   150,   -45,   -15,     0]*pi/180;                   %joint angles  (first element ignored)
