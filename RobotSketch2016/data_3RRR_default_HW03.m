...
dh.t = [nan,     135,    45-h,    h-45,       0; ...                            %leg 1: joint angles        0...n+1 (the n+1 angle is the offset angle)
        nan,     -45,    45+h,    90-h,      45; ...                            %leg 2: joint angles        0...n+1
        nan,    -135,   135-h,  -180+h,     -45]*pi/180;                        %leg 3: joint angles        0...n+1
dh.a = [  0, sqrt(8), sqrt(5), sqrt(8),     nan; ...                            %leg 1: link lengths 0...n+1
          0, sqrt(8), sqrt(5),       2,     nan; ...                            %leg 2: link lengths 0...n+1
          0, sqrt(8), sqrt(5),       2,     nan];                               %leg 3: link lengths 0...n+1
...
dh.p1   = ...
       [      8,       0,      0; ...                                           %leg 1: base frame location
