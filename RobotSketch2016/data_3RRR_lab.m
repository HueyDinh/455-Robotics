...
dh.t = ...
       [nan, -45.0426, 107.4673, -62.4246,       0; ...                         %leg 1: joint angles        0...n+1
        nan,-165.0426, 107.4673, -62.4246,     120; ...                         %leg 2: joint angles        0...n+1
        nan,  74.9574, 107.4673, -62.4246,    -120]*pi/180;                     %leg 3: joint angles        0...n+1
dh.a = ...
       [  0,     11.9,      9.5,      3.1,     nan; ...                         %leg 1: link common normals 0...n+1
          0,     11.9,      9.5,      3.1,     nan; ...                         %leg 2: link common normals 0...n+1
          0,     11.9,      9.5,      3.1,     nan];                            %leg 3: link common normals 0...n+1
dh.d = ...
       [nan,       3,         0,        0,       0; ...                         %leg 1: joint offsets       0...n+1
        nan,       3,         0,        0,       0; ...                         %leg 2: joint offsets       0...n+1
        nan,       3,         0,        0,       0];                            %leg 3: joint offsets       0...n+1
dh.f = ...
        [ 0,       0,         0,        0,     nan; ...                         %leg 1: link twist angles   0...n+1
...
dh.p1   = ...
       [-15.906,       0,      0; ...                                           %leg 1: base frame location
          7.953,  13.775,      0; ...                                           %leg 2: base frame location
          7.953, -13.775,      0];                                              %leg 3: base frame location
...
%local platform vertices: 1) local frame on leg 1: origin at joint 3 and x axis along link a_3
%                         2) coordinates sequentially go around the vertices with the gripper (if present) the last
dh.Hx = [ 0, 4.65,  4.65];                                                    %x coords - order is legs 3, 1, 2 and gripper vertices
dh.Hy = [ 0, 2.68, -2.68];                                                    %y coords - order is legs 3, 1, 2 and gripper vertices
